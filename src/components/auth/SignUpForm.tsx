...
import { SignUpFormInputs, signUpSchema } from "@/src/schemas/auth";
    ...
    return (
        <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
            <div className="pt-2 flex flex-col gap-4">
                ...
                <Button variant="outline" className="group/google" type="button" onClick={signUpWithGoogle}>
            ...
            <p className="text-center text-sm text-gray-400 pt-2">
                Already a player?
                <Link className="ml-1 text-primary hover:text-white font-bold transition-colors" href="/auth/login">Log in here</Link>
            </p>
        </form>
    )
}