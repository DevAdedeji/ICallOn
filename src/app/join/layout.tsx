...
export default function AuthLayout({
    ...
    return (
        <main className="font-manrope bg-background-light dark:bg-background-dark text-[#131811] dark:text-white antialiased min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-grid-pattern">
